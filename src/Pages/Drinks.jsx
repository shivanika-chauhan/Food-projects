...
const DrinksPage = () => {
  ...
  const displayedDrinks = showAll ? drinks : drinks.slice(0, 8);
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      {/* VIEW ALL BUTTON */}
      {!showAll && drinks.length > 8 && (
        <div className="text-center mt-8">
          <button
            onClick={() => setShowAll(true)}
            className="bg-orange-500 text-white px-8 py-2 rounded-lg 
